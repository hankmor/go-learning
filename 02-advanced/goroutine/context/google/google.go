...
func Search(ctx context.Context, query string) (Results, error) {
	...
	// req, handleerr := http.NewRequest("GET", "https://ajax.googleapis.com/ajax/services/search/web?v=1.0&key="+key+"&cx=053d09c819fa04043", nil)
	if err != nil {
		return nil, err
	}
...
func httpDo(ctx context.Context, req *http.Request, f func(*http.Response, error) error) error {
	...
	case err := <-c: // f成功执行,handleerr 为nil，或者 f 执行返回了 error
		return err
	}
}
